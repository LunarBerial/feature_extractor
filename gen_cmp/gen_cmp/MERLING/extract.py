...
datapath = '/home/mdisk/data/jietong/liangjiahe/out-h/'
def make_input_output_file_list ():
    ...
    output_list = ['./' + 'cmp/' + item + '.cmp' for item in file_checked_ids]

    output_norm_list = ['./' + 'normed_cmp/' + item + '.cmp' for item in file_checked_ids]
...
if __name__ == '__main__':
    ...
    in_file_list_dict, nn_cmp_file_list, nn_cmp_norm_file_list = make_input_output_file_list ()     
