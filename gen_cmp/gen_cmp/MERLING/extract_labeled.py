...
if __name__ == '__main__':
    ...
    for data in datalist:
        ...
        in_dimension_dict = {'mgc' : 60, 'lf0' : 1, 'bap' : 3}
        out_dimension_dict = {'mgc' : 180, 'vuv' : 1, 'lf0' : 3, 'bap' : 9}
        ...
        cmp_dim = 193
        nn_cmp_file_list = [datapath + 'normed_cmp/' + item for item in os.listdir(datapath+'normed_cmp')]
